...
language_error_t name_table_ctor        (language_t         *ctx,
                                         size_t             capacity);
...
language_error_t used_names_ctor        (language_t        *ctx,
                                         size_t             capacity);
...
language_error_t variables_stack_ctor   (language_t        *ctx,
                                         size_t             capacity);

language_error_t variables_stack_push   (language_t        *ctx,
                                         size_t             nt_index);

language_error_t variables_stack_remove (language_t        *ctx,
                                         size_t             number);
