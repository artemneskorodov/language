...
language_error_t used_names_add(language_t *language, const char *name, size_t length, size_t *output);
...
language_error_t variables_stack_push(language_t *language, size_t nt_index);
